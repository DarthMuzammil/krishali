    ...
    <footer className="bg-gray-800 text-white py-12">
      <div className="container mx-auto px-4 space-y-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            <h4 className="font-semibold text-lg mb-4">Krishali Consultancy FZE</h4>
            <p className="text-sm mb-4">
              Providing expert consultancy services in Sharjah and beyond. Your trusted partner for business solutions.
            </p>
            ...
            >
              <div className="flex items-start space-x-2 text-sm group-hover:text-blue-400 transition-colors duration-200">
                ...
                <p>
                  ...
                  Office 2309, R2, Near Multi Trade,<br />
          ...
          <div>
            ...
            <div className="space-y-2">
              <p className="text-sm flex items-center">
                ...
                <Link href="https://wa.me/971503714039" className="hover:underline">
                  +971 50 371 4039
                </Link>
              </p>
              <p className="text-sm flex items-center">
                <Mail size={18} className="mr-2" />
                <Link href="mailto:contact@krishaliconsultancy.com" className="hover:underline">
        ...
        <div className="mt-4 pt-4 border-t border-gray-700 text-center text-xs">
          <p>&copy; {new Date().getFullYear()} Krishali Consultancy FZE. All rights reserved.</p>
