...
export const locations = {
  landmarktower: {
    ...
    activities: [
      ...
      },
      {
        ...
        timing: [{ days: "Friday", time: "2:00PM - 3:00PM" }, { days: "Friday", time: "7:00PM - 11:00PM" }, { days: "Saturday", time: "6:00AM - 8:00AM" }, { days: "Saturday", time: "1:00PM - 11:00PM" }],
        trainer: "Karim",
        caption: "Now in Golden Falcon Tower, Du Building",
      },
    ],
  ...
  goldenfalcontower: {
    ...
    metadata: {
      title: "Kickboxing, Zumba, Swimming Classes in Corniche, Landmark Tower",
      description:
        "Enjoy swimming, zumba, yoga classes at Landmark Tower Corniche",
      keywords:
        "Swimming classes and Zumba classes with Sauna Pool and Gym facilities at Landmark Tower Corniche managed by Kirshali Wellness (Krishali Group)",
